...
/**
 * @see <a href='https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/java/com/blankj/utilcode/util/ProcessUtils.java'>AndroidUtilCode's ProcessUtils</a>
 */
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) BaseUtils.getAppContext().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(BaseUtils.getAppContext().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) BaseUtils.getAppContext().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) BaseUtils.getAppContext()
    ...
    public static boolean isMainProcess() {
        return BaseUtils.getAppContext().getPackageName().equals(getCurrentProcessName());
    }
    ...
    private static String getCurrentProcessNameByReflect() {
        String processName = "";
        try {
            Application app = (Application) BaseUtils.getAppContext();
