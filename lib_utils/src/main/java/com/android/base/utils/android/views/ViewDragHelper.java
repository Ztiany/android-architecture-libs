...
/**
 * 修改自 androidx 中的 ViewGradHelper，Callback 中添加了一个方法 {@link Callback#checkInterceptionSlope(View, float, float)}。
 */
public class ViewDragHelper {
    ...
    public abstract static class Callback {
        ...
        public abstract boolean checkInterceptionSlope(View toCapture, float dx, float dy);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    final View toCapture = findTopChildUnder((int) x, (int) y);
                    final boolean pastSlop = toCapture != null && checkTouchSlop(toCapture, dx, dy) && mCallback.checkInterceptionSlope(toCapture, dx, dy);
