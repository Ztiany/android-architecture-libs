...
public class GestureLockThumbnailView extends View {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mNormalColor = array.getColor(R.styleable.GestureLockThumbnailView_thumbnail_normal_color, Painter.NORMAL_COLOR);
        mSelectorColor = array.getColor(R.styleable.GestureLockThumbnailView_thumbnail_selected_color, Painter.PRESS_COLOR);
     ...
     */
    public void setThumbnailView(String number) {
        // 0.数字序列合法性判断
