...
class OptimizeBannerPagerAdapter extends PagerAdapter {
    ...
    private final List<Uri> mEntities;
    private final List<ImageView> mLayouts = new ArrayList<>();
    private OnPageClickListener mOnPageClickListener;
    private boolean mIsLooper;
    private ImageLoader mImageLoader;

    OptimizeBannerPagerAdapter(BannerViewPager bannerViewPager, List<Uri> entities, String transitionName) {
        mContext = bannerViewPager.getContext();
        mImageLoader = bannerViewPager.getImageLoader();
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        mImageLoader.display(image, uri);
